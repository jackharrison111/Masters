...
jps.AthenaCommonFlags.HistOutputs = ["MYSTREAM:local_outputs/outputJ_OpenAng_" + dt.datetime.now().strftime("%d-%m_%H:%M") + ".root"]  #register output files like this. MYSTREAM is used in the code
...
jps.AthenaCommonFlags.FilesInput = ["/afs/cern.ch/user/j/jaharris/public/mc16_13TeV/AOD.19119260._000001.pool.root.1"]
#mc15_13TeV.361108.PowhegPythia8EvtGen_AZNLOCTEQ6L1_Ztautau.recon.AOD.e3601_s2576_s2132_r6630_tid05358802_00/AOD.05358802._004299.pool.root.1"]        #set on command-line with: --filesInput=...
