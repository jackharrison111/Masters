  ...
  */
  ...
  if(tau_partner_pt != 0){
	...
	k++;
      ...
      const xAOD::MissingET* met7 = met_track->at(0);
      double met7_pt = met7->met() /1000;
      double met7_phi = met7->phi();


      // MET
      double met_pt = met7_pt;   //(*met_container)["FinalTrk"]->met() / 1000;
      double m_phi =   met7_phi;   //(*met_container)["FinalTrk"]->phi();
      int j{};
      const xAOD::MissingETContainer* met_core = nullptr;
      CHECK( evtStore()->retrieve(met_core, "MET_Core_" + jet_type) );
	...
	j++;
      ...
      const xAOD::MissingET* met = met_core->at(1);  //0 = SoftClusCore , 1 = PVSoftTrk , 2 = SoftClusEMCore 
