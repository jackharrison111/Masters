...
foreach(_expectedTarget WorkDir::DiTauPkg WorkDir::DiTauPkgPrivate WorkDir::DiTauLib WorkDir::DiTau)
...
# Create imported target WorkDir::DiTauPkg
add_library(WorkDir::DiTauPkg INTERFACE IMPORTED)

set_target_properties(WorkDir::DiTauPkg PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/src/DiTau"
)

# Create imported target WorkDir::DiTauPkgPrivate
add_library(WorkDir::DiTauPkgPrivate INTERFACE IMPORTED)

# Create imported target WorkDir::DiTauLib
add_library(WorkDir::DiTauLib SHARED IMPORTED)
...
# Create imported target WorkDir::DiTau
add_library(WorkDir::DiTau MODULE IMPORTED)

set_target_properties(WorkDir::DiTau PROPERTIES
  INTERFACE_LINK_LIBRARIES "WorkDir::DiTauLib;GaudiPluginService"
)
