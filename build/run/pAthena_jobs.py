...
#    'mc16_13TeV.361108.PowhegPythia8EvtGen_AZNLOCTEQ6L1_Ztautau.merge.AOD.e3601_e5984_s3126_r10530_r10541_tid14316749_00',       'mc16_13TeV.361108.PowhegPythia8EvtGen_AZNLOCTEQ6L1_Ztautau.merge.AOD.e3601_e5984_s3126_s3136_r10724_r10726_tid15260020_00',
...
<<<<<<< HEAD
command += " --mergeOutput --outDS user.jaharris.First3xAOD_MMC_Col_OpenAngCut2_" + dt.datetime.now().strftime("%d-%m_%H-%M") + " ~/public/Masters/build/x86_64-centos7-gcc62-opt/jobOptions/DiTau/DiTauAlgJobOptions.py"
=======
command += " --mergeOutput --outDS user.jaharris.First3xAOD_MMC_Col_OpenAngCut2" + dt.datetime.now().strftime("%d-%m_%H-%M") + " ~/public/Masters/build/x86_64-centos7-gcc62-opt/jobOptions/DiTau/DiTauAlgJobOptions.py"

>>>>>>> f5896b0d5091aa81b1379040211632aebe6dde86
print command
os.system(command)
print "\n"
