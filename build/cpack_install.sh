...
# build mode:
rm -f ${DESTDIR}/usr/WorkDir/1.0.0/InstallArea/x86_64-centos7-gcc62-opt/bin/*.dbg
rm -f ${DESTDIR}/usr/WorkDir/1.0.0/InstallArea/x86_64-centos7-gcc62-opt/lib/*.dbg
